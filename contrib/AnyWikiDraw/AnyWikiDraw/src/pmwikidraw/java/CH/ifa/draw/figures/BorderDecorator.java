...
public  class BorderDecorator extends DecoratorFigure {
    ...
    public void draw(Graphics g, boolean showGuides) {
        Rectangle r = displayBox();
         ...
         //Dodgy drop shadow code. 
        Color oldFillColour = (Color)super.getAttribute("FillColor");
        super.setAttribute("FillColor", Color.black);
        Point border = border();
        super.moveBy(border.x,border.y);
        super.draw(g, showGuides);
        
        super.setAttribute("FillColor", oldFillColour);
        super.moveBy(-border.x,-border.y);
        super.draw(g, showGuides);
        /*
