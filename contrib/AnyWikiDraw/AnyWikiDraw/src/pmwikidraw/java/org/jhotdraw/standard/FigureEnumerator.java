...
*/
	...
	/* (non-Javadoc)
   * @see org.jhotdraw.framework.FigureEnumeration#contains(org.jhotdraw.framework.Figure)
   */
  public boolean contains(Figure figure)
  {
    Iterator figs = myInitialCollection.iterator();
    while(figs.hasNext()) {
      if( ((Figure)figs.next()).includes(figure) ) 
        return true;
    }
    return false;
  }
