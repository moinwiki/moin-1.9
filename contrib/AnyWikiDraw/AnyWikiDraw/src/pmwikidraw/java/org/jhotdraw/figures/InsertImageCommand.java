...
public class InsertImageCommand extends AbstractCommand {
	...
	public InsertImageCommand(String name, String newImageName, DrawingEditor newDrawingEditor, String relativeUrlPath) {
		super(name, newDrawingEditor);
		myImageName = newImageName;
	...
	protected Undoable createUndoActivity() {
		return new InsertImageCommand.UndoActivity(view(), myImageName, relativeUrl);
	}
	...
	public class UndoActivity extends UndoableAdapter {
		...
		UndoActivity(DrawingView newDrawingView, String newAffectedImageName, String relativeUrl) {
		...
		protected ImageFigure getImageFigure() {
			...
			if ((myAffectedImageFigure == null) || (myAffectedImageFigure.get() == null)) {
				...
				setImageFigure(new ImageFigure(
					image, myAffectedImageName, getDrawingView().lastClick(), myRelativeUrl));
			}
