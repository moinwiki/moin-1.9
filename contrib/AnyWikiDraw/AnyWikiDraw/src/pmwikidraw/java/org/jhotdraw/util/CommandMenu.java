...
public  class CommandMenu extends JMenu implements ActionListener, CommandListener {
	 ...
	 * the command's name.
	 */
	public synchronized void addCheckItem(Command command, boolean initialState) {
		addMenuItem(command, new JCheckBoxMenuItem(command.name(), initialState));
	}
