...
public class TextAreaFigure extends AttributeFigure
	...
	/** The current font */
	protected Font fFont = new Font("Arial", 12, Font.PLAIN);
	/**
	...
	public Font createFont() {
		...
		return new Font((String)getAttribute(FigureAttributeConstant.FONT_NAME),
				((Integer)getAttribute(FigureAttributeConstant.FONT_STYLE)).intValue(),
				((Integer)getAttribute(FigureAttributeConstant.FONT_SIZE)).intValue());
	}
...
//			System.out.println("Saving clip area:"+savedClipArea);
		...
		if (g2 != null) {
//			if(savedClipArea != null) {
			//CJ 29/11/04 : It is valid to have a null clip area. let it be.
	...
	public void setAttribute(FigureAttributeConstant attributeConstant, Object value) {
		...
		if ( attributeConstant == FigureAttributeConstant.FONT_SIZE ) {
			...
			setFont(new Font(font.getName(), style, font.getSize()));
			// store the attribute
			super.setAttribute(attributeConstant, new Integer(style));
		}
	...
	/* (non-Javadoc)
	 * @see org.jhotdraw.standard.AbstractFigure#getTextHolder()
	 */
