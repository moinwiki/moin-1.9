...
public abstract class CompositeFigure
	 ...
	 * Fixes applied from TwikiDraw by Rob Walker.  Fixes dodgy Connected Text issues :) 
	...
	protected void basicMoveBy(int x, int y) {
      ...
      Figure obsrvd = (Figure) fig.getAttribute(FigureAttributeConstant.OBSERVED_FIGURE);
