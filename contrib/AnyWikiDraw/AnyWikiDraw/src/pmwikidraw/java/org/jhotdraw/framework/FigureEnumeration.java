...
public interface FigureEnumeration {
	...
	/** 
	 * CJ: Fixed to get Connected text working nicely.
	 * Returns true if the passed Figure is included within the selection somewhere.
	 * (This *does* take into account nesting.)
	 * 
	 */
