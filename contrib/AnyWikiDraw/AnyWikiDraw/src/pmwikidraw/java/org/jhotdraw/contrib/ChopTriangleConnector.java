...
public class ChopTriangleConnector extends ChopBoxConnector {
  ...
  public ChopTriangleConnector(TriangleFigure owner) {
	...
	/**
	 * Return an appropriate connection point on the edge of a triangle figure
	 */
	protected Point chop(Figure target, Point from) {
		return super.chop(target, from);
		/*
		TriangleFigure triangleFigure = (TriangleFigure)target;
		System.out.println(triangleFigure.getRotationAngle());
